...
CACHE_DIR = '/fs/fast/share/aimind_files/video_eval/models/ViCLIP'
class ViCLIP(nn.Module):
    """docstring for ViCLIP"""

    def __init__(self,  tokenizer=None, pretrain=os.path.join(CACHE_DIR, "ViClip-InternVid-10M-FLT.pth"), freeze_text=True):
